...
namespace {
sf::Texture& getTexture(std::map<std::string, sf::Texture>& textureCache, const std::string& name) {
...
sf::Texture& tex = getTexture(textureCache, texKey);
...
getTexture(textureCache, bgName);
